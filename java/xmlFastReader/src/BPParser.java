...
public class BPParser {
     ...
     */
    public static HashMap<String, TokenEntity> parseBP(String bpFilePath, int numThreads) throws IOException {
        HashMap<String, TokenEntity> allTokenEntity = new HashMap<>();
                ...
                if (currentLine.startsWith("file:")) {
                    ...
                    if (currentEntity != null) {
                        if (currentEntity.totalColumn > 0) {
                            ...
                            allTokenEntity.put(currentEntity.fileName, currentEntity);
                        }
                    }
